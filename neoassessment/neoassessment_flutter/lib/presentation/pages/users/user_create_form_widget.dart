...
//
//   const UserCreateForm({super.key, required this.domains, required this.roles});
//
//   @override
...
//                 } else {
//                   dropdownvalue = widget.domains[0].name!.toString();
//                 }
//                 return Padding(
//                   padding: const EdgeInsets.only(
//                       left: 10.0, right: 10.0, top: 15, bottom: 0),
...
//                           .add(ChangeDomainEvent(dropdownvalue, domainId));
//                     },
//                     icon: const Padding(
...
//               } else {
//                 roledropdownvalue = widget.roles[0].name!.toString();
//               }
//               return Padding(
//                 padding: const EdgeInsets.only(
...
//                       if (newValue == widget.roles[i].name) {
//                         roleId = widget.roles[i].id!;
//                         break;
//                       }
//                     }
//
//                     BlocProvider.of<RemoteUsersBloc>(context)
//                         .add(ChangeRoleEvent(roledropdownvalue, roleId));
//                   },
//                   icon: const Padding(
//                       padding: EdgeInsets.only(left: 20),
//                       child: Icon(Icons.arrow_circle_down_sharp)),
...
//               //   return current is CreateRemoteUserDone ||
...
//                   );
//                 }
//                 if (state is CreateRemoteUserDone) {
//                   ScaffoldMessenger.of(context).showSnackBar(
//                     SnackBar(
