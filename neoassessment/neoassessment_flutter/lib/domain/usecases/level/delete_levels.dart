...
class DeleteLevelsUseCase extends UseCase<DataState<dynamic>, LevelEntity> {
  final LevelRepository _levelRepository;

  DeleteLevelsUseCase(this._levelRepository);

  @override
  Future<DataState<dynamic>> call({LevelEntity? params}) {
    final result = _levelRepository.deleteLevels(params!);
    return result;
  }
}
