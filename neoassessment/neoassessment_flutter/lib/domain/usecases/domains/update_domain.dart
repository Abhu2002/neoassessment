...
class UpdateDomainUseCase extends UseCase<DataState<dynamic>, DomainEntity> {
  final DomainRepository _domainRepository;

  UpdateDomainUseCase(this._domainRepository);

  @override
  Future<DataState<dynamic>> call({DomainEntity? params}) {
    final result = _domainRepository.updateDomain(params!);
    return result;
  }
}
